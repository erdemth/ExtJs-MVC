...
Ext.define('ExtApp.view.sys.main.desktop.Settings', {
    ...
    uses: [
        ...
        'ExtApp.view.sys.main.desktop.Wallpaper'
    ],
    ...
    initComponent: function () {
        ...
        me.items = [{
            ...
            xtype: 'checkbox',
            boxLabel: 'Stretch to fit the screen',
            checked: me.stretch,
            listeners: {
    ...
    createTree: function () {
        ...
        var tree = new Ext.tree.Panel({
            ...
            store: new Ext.data.TreeStore({
                model: 'ExtApp.view.sys.main.desktop.Wallpaper',
                root: {
                    text: 'Wallpaper',
                    expanded: true,
                    children: [{
